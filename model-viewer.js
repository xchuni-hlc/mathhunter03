...
AFRAME.registerComponent('model-viewer', {
  ...
  initEntities: function () {
    ...
    modelEl.setAttribute('rotation', '10 -30 0');
  ...
  onThumbstickMoved: function (evt) {
    ...
    modelScale = Math.min(Math.max(0.4, modelScale), 1.4);
  ...
  centerAndScaleModel: function () {
    ...
    this.cameraRigEl.object3D.position.z = 10.0;
    ...
    modelEl.object3D.scale.set(0.25, 0.25, 0.25);
    ...
    modelEl.object3D.position.y = -center.y - 2;
